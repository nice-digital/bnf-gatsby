...
export const EULAContent: React.FC = () => (
	<section>
		...
		<div className={styles.terms}>
			<ol>
				<li>
					<span className={styles.section}>This contract and the NICE BNF</span>
					<ol>
						<li>
						...
						<li>
							...
							into this contract on behalf of that organisation. Otherwise, you
							will be entering into this contract in your personal capacity.
						</li>
					</ol>
				</li>
				<li>
					...
					<ol>
						<li>
							...
							<ol>
								<li>
									Are a member of the public acting in a private capacity (e.g.
									individual patient); in which case:
									<ol>
										<li>
											You are allowed to Use the NICE BNF for{" "}
											<strong>personal reference purposes only</strong> and not
											on behalf of or for the benefit of any company,
										...
										<li>
											...
											substitute for a consultation with a qualified clinician.
											You must only follow the guidance of a registered medical
											practitioner. You understand that the NICE BNF is written
											for qualified clinicians and not patients.
										</li>
									</ol>
								</li>
								<li>
									...
									<ol>
										<li>
											...
											<strong>
												...
												behalf of the National Health Service and using the NICE
												BNF solely for the benefit of the National Health
												Service and patients.
											</strong>
										</li>
										<li>
											You understand that the guidance contained within the NICE
											BNF is not a substitute for you exercising your own
											professional judgment. Furthermore, you recognise that the
											NICE BNF is one of a range of information sources that may
											inform your judgment and you should not place sole
											reliance on the NICE BNF.
										</li>
									</ol>
								</li>
							</ol>
						...
						<li>
							...
							you do not, you understand that by Using the NICE BNF you or your
							organisation will be infringing Our intellectual property rights.
						</li>
						<li>
							For the avoidance of doubt, the following, without limitation, are
							not permitted to Use the NICE BNF (but may do so by contacting RPS
							and entering into a commercial or academic licence):
							<ol>
								<li>
									schools, universities, and other educational establishments,
									or individuals working for or studying at the same (except for
									students using the NICE BNF in the setting of an NHS
									placement);
								</li>
								<li>anyone outside the UK; and/or</li>
								<li>
									companies, businesses, and any other private enterprises that
									are not part of the National Health Service. Companies,
				...
				<li>
					...
					<ol>
						<li>
							You understand that your Use of the NHS BNF is limited as follows:
							-
							<ol>
								<li>
								...
								<li>
									...
									exploitation by or for anyone or any enterprise outside of the
									National Health Service in the UK.
								</li>
								<li>
									You may not create hyperlinks to the NICE BNF within any
									computer system or take any steps to make the NICE BNF
									available to anyone except NHS users and patients. If you wish
									to place links to the BNF within your computer systems you
									must contact Us for a linking licence.
								</li>
								<li>
									Data scraping and data mining of the NICE BNF is not
									permitted. Anyone (including NHS bodies) seeking to ingest BNF
									data into a computer system or database must contact Us and
									enter into a data licence. It is prohibited to provide the
									NICE BNF as AI training data for any AI system.
								</li>
								<li>
								...
								<li>
									...
									any part), save that if you are a clinician you are allowed to
									distribute NICE BNF to patients or colleagues to the extent
				...
				<li>
					...
					<ol>
						<li>
							...
							and accordingly We do not give any warranty express of implied or
							...
							<ol>
								...
								<li>That the NICE BNF if complete, accurate or up to date.</li>
							</ol>
						</li>
						<li>
						...
						<li>
							...
							it limit Our liability for death or personal injury caused by Our
							negligence. Otherwise however, in consideration of Us giving you
							permission to Use the NICE BNF for no charge, you agree that Our
							liability arising under or in connection with this contract is
							limited to £1. We are willing to accept a higher level of
				...
				<li>
					...
					<ol>
						<li className={styles.noNumbering}>
							This contract may be terminated by Us at any time if we reasonably
							consider you may have broken the terms. If the contract is
							terminated, your right to Use the NICE BNF terminates.
						</li>
					</ol>
				</li>
				<li>
						...
						<li>
							...
							<ol>
								...
								<li>
									...
									notebooks, mobile phones, portable hard-drives, memory sticks
								...
								<li>
									...
									display on your web-browser, printing off a single screen only
									and downloading, storing and using the NICE BNF on Portable
									Devices for temporary internal reference purposes (e.g. where
									internet access may present difficulties accessing the NICE
									BNF) and explicitly <strong>excludes</strong> commercial use
									and use within computerised decision support tools and
									generative AI software. At no stage can copies be made of a
									substantial part of the NICE BNF under these terms.
								</li>
								<li>
