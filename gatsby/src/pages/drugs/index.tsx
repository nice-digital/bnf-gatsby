...
const DrugsIndexPage: FC<DrugsIndexPageProps> = ({
	...
	<AtoZListPage
		...
		letters={letters}
		pageDescription="Browse drug monographs by A to Z. Drug monographs describe the uses, doses, safety issues, medicinal forms and other considerations involved in the use of a drug."
	/>
);
