...
export type BorderlineSubstancesLeafPageProps = {
	data: {
		bnfBorderlineSubstancesTaxonomyLeaf: SlugAndTitle & {
...
const BorderlineSubstancesLeafPage: FC<BorderlineSubstancesLeafPageProps> = ({
	data: {
		bnfBorderlineSubstancesTaxonomyLeaf: {
			slug,
			title,
			rootTaxonomy,
			substances,
...
export const query = graphql`
	query ($id: String) {
		bnfBorderlineSubstancesTaxonomyLeaf(id: { eq: $id }) {
			slug
			title
			rootTaxonomy {
				slug
			...
			parentTaxonomy {
				... on BnfBorderlineSubstancesTaxonomy {
					title
				}
				... on BnfBorderlineSubstancesTaxonomyRoot {
					title
				}
			}
		}
...
export default BorderlineSubstancesLeafPage;
